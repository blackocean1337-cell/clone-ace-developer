...
export const products: Product[] = [
  ...
  },
  {
    ...
    galleryImages: [tshirtVneck, productModel1, productModel2, productBlackBack],
    colors: vneckColors,
    sizes: defaultSizes,
    features: defaultFeatures,
    description: [
  ...
  ...([
    { slug: "t-shirt-col-v-cinzento", img: tshirtVneckCinzento },
    { slug: "t-shirt-col-v-azul-ceu", img: tshirtVneckAzulCeu },
    { slug: "t-shirt-col-v-salmao", img: tshirtVneckSalmao },
    { slug: "t-shirt-col-v-turquesa", img: tshirtVneckTurquesa },
    { slug: "t-shirt-col-v-bordeaux", img: tshirtVneckBordeaux },
    { slug: "t-shirt-col-v-bege", img: tshirtVneckBege },
    { slug: "t-shirt-col-v-verde-militar", img: tshirtVneckVerdeMilitar },
  ].map(({ slug, img }) => ({
    slug,
    name: "A t-shirt gola V",
    price: 18,
...
).concat(products.filter((p) => ["t-shirt-manches-longues", "t-shirt-col-v", "polo"].includes(p.slug)));
