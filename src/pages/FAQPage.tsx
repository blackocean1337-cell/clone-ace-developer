    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 pt-16 pb-24">
        ...
        <div className="text-center mt-8">
          ...
          <a
            href="href="mailto:info@mrtuga.co""
