...
const sections = [
  ...
  {
    title: "Trocas",
    content: `Apenas substituímos artigos que apresentem defeito de origem ou que estejam danificados. Se precisar de substituir o seu artigo pelo mesmo, envie-nos um e-mail para support@mrtuga.com.`,
  },
  {
    title: "Presentes",
  ...
  },
  {
    ...
    content: `Para efetuar uma devolução, envie o artigo para:\n\nMRTUGA\nLisboa, Portugal\n\nPor favor contacte-nos em support@mrtuga.com antes de enviar a devolução para obter a morada exata e instruções de envio.`,
  },
  {
