  ...
  return (
    <section className="bg-fincut-black py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        <div>
          <p className="font-body text-xs tracking-widest text-fincut-gold uppercase mb-2">Économisez plus</p>
          <h2 className="font-display text-2xl sm:text-3xl font-bold text-secondary-foreground">
            Votre pack personnalisé pour la semaine.
          </h2>
          <motion.a
            href="#"
        ...
        <div className="overflow-hidden">
          <img src={packImage} alt="Pack personnalisé" className="w-full object-cover" loading="lazy" />
        </div>
      </div>
    </section>
  );
