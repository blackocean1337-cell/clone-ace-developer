        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm text-fincut-gray">
              ...
              <li><a href="mailto:info@mrtuga.co" className="hover:text-secondary-foreground transition-colors underline">Contacte-nos</a></li>
          ...
          <div>
            ...
            <p className="font-body text-sm text-fincut-gray leading-relaxed">
              ...
              <a href="mailto:info@mrtuga.co" className="hover:text-secondary-foreground transition-colors underline">info@mrtuga.co</a>
            </p>
          </div>
