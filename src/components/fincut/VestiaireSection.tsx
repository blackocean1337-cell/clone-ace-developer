...
const VestiaireSection = () => {
  ...
  return (
    <section id="vestiaire" className="bg-fincut-black py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h2 className="font-display text-2xl sm:text-3xl font-bold text-secondary-foreground">Votre vestiaire</h2>
        ...
        <div ref={scrollRef} className="flex gap-4 sm:gap-6 overflow-x-auto scrollbar-hide pb-4">
          {products.map((p, i) => (
            <div key={i} className="min-w-[200px] sm:min-w-[260px] flex-shrink-0">
