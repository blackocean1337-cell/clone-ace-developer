...
const tshirtWhite = "/lovable-uploads/e49adb7b-5a69-4ca3-8159-1d3.f4e70974b.png";
              ...
              style={{
                ...
                <div className="px-2 py-1.5">
                  ...
                  <div className="flex items-center gap-1 mt-0.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-fincut-black border border-slate-500" />
